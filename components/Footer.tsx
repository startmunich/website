...
export default function Footer() {
  return (
    <footer className="bg-brand-dark-blue">
      <div className="mx-auto px-6 pb-0 pt-10 md:px-20">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <a
            ...
            className="text-sm font-bold uppercase tracking-widest text-white transition-colors hover:text-brand-pink"
          >
            DONATE
          </a>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-white transition-colors hover:text-brand-pink"
