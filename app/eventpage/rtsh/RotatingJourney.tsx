...
export default function RotatingJourney() {
  ...
  return (
    <div
      className="mt-[34px] max-w-[620px] rounded border border-[#34e1b8]/15 bg-gradient-to-b from-[#144146]/50 to-[#144146]/15 p-[22px_24px]"
      aria-hidden="true"
    >
      <p className="text-[0.7rem] font-bold uppercase tracking-[0.22em] text-[#69988f]">
        The journey
      </p>
